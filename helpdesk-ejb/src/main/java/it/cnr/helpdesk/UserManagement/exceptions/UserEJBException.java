...
public class UserEJBException extends HelpDeskEJBException
{

    public UserEJBException()
    {
    }

    public UserEJBException(String s)
    {
        super(s);
    }

    public UserEJBException(String s, String s1)
    {
        super(s, s1);
    }
