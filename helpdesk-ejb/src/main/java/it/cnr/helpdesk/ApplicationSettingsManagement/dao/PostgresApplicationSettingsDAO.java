...
public class PostgresApplicationSettingsDAO extends HelpDeskDAO implements ApplicationSettingsDAO
{

 public PostgresApplicationSettingsDAO()
 {
     con = null;
 }
...
public void setProperty(String key, String value) throws ApplicationSettingsDAOException {
	...
	try {
		if(getProperty(key) == null) {
			String s = "select nextval('seq_setting')";
