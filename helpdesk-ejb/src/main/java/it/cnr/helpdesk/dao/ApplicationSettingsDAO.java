...
public interface ApplicationSettingsDAO {
   ...
   public Vector getId2DescriptionStateMapping()throws ApplicationSettingsDAOException;

   public Vector getId2DescriptionPriorityMapping()throws ApplicationSettingsDAOException;
   ...
   public void closeConnection()throws ApplicationSettingsDAOException;
}
