...
public class HelpDeskJBException extends Exception
    implements HelpDeskExceptionInterface
{

    public HelpDeskJBException()
    {
    }

    public HelpDeskJBException(String s)
    {
        super(s);
    }

    public HelpDeskJBException(String s, String s1)
    {
        super(s);
        userMessage = s1;
    }
     ...
     */
    public HelpDeskJBException( Throwable cause ) {
        this.rootCause = cause;
    }
    
    
    public HelpDeskJBException( String msgKey, Object[] args ) {
