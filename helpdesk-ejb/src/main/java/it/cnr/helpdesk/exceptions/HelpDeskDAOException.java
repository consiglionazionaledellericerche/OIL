...
public class HelpDeskDAOException extends Exception
    implements HelpDeskExceptionInterface
{

    public HelpDeskDAOException()
    {
    }

    public HelpDeskDAOException(String s)
    {
        super(s);
    }

    public HelpDeskDAOException(String s, String s1)
    {
        super(s);
        userMessage = s1;
    }
