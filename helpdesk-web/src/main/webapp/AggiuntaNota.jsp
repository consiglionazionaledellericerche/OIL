...
<title>Online interactive helpdesk Aggiungi Nota</title>
<!-- #EndEditable -->
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
  		<td>
            ...
            <img src="<%=skName%>/titles/AggiungiNota.gif"><!-- #EndEditable -->
					</td>
...
<table align='center' class="bordertab">
	...
	<tr><td><div class="text">Nota</div></td></tr>
	<tr><td><textarea disabled rows="10" cols="60"><%=request.getAttribute("nota") %></textarea></td></tr>
...
if (idSegnalazioneString!=null) {
	...
	session.setAttribute("it.cnr.helpdesk.currentIdSegnalazione",idSegnalazione);
} else {
	idSegnalazione=(Long) session.getAttribute("it.cnr.helpdesk.currentIdSegnalazione");    
}
%>
<form name="AggiuntaNota" method="POST" action="AggiuntaNota.do">
        <table border="0" width="100%" cellpadding="2" cellspacing="2">
          <tr class="bgheader"> 
            <td width="10%"> 
              <div class="tableheader">Nota</div></td>
            <td width="90%"> 
              <textarea rows="10" name="Nota" cols="60"></textarea>
    </td>
  </tr>
</table>
