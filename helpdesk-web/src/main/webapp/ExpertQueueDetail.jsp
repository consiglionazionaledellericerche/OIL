    ...
    <td > 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
			...
			<% if(closed.equals("NO")){ %>
            <a href="ProblemCountPerCategory.do?closed=NO" class="navigation"><bean:message key="PendingTickets" /> : <bean:message key="CountPerCategory" /></a> --&gt; <bean:message key="PendingTicketsList" />
            <%} else  if(closed.equals("YES")){ %>
            <a href="ProblemCountPerCategory.do?closed=YES" class="navigation"><bean:message key="ClosedTickets" /> : <bean:message key="CountPerCategory" /></a> --&gt; <bean:message key="ClosedTicketsList" />
            <%} else if(closed.equals("VER")){ %>
            <a href="ProblemCountPerCategory.do?closed=VER" class="navigation"><bean:message key="VerifiedTickets" /> : <bean:message key="CountPerCategory" /></a> --&gt; <bean:message key="VerifiedTicketsList" />
            <%} else if(closed.equals("STO")){ %>
            <a href="ProblemCountPerCategory.do?closed=STO" class="navigation"><bean:message key="TicketRepository" /> : <bean:message key="CountPerCategory" /></a> --&gt; <bean:message key="TicketsArchiveList" />
            <%} else if(closed.equals("QBE")){ %>
            <a href="ExpertQBESettings.do" class="navigation"><bean:message key="AdvancedSearch" /></a> --&gt; <bean:message key="SearchResults" />
            <%}%>
            <!-- #EndEditable --></span> 
          </td>
...
%>
              <tr <%= (plivo.getEvidenza()!= null)?plivo.getEvidenza().startsWith("y")?"bgcolor='#00FFFF'":"":""%> > 
