...
<title><bean:message key="applicationName" /> -  <bean:message key="pageTitles.ManageValidators" /></title>
<!-- #EndEditable -->
    ...
    <td > 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
            ...
            --&gt; <bean:message key="navigation.ManageValidator" /><!-- #EndEditable --></span> 
          </td>
          ...
          <td valign="top" height="400" ><!-- #BeginEditable "Content" --> 
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="text">
              <tr>
				...
				<td width="1"></td> 
				<td width="150" align="center" class="bgheader"><span class="tab"><bean:message key="tabs.ManageValidators" /></span> </td>
		        <td >&nbsp;</td>				
	</tr>
</table>		  
...
<p><a href='<%=(viewAll?"ManageValidator.do?viewAll=n":"ManageValidator.do?viewAll=y")+listAll %>'><img <%=viewAll?"src='"+skName+"/hide.gif' alt='Nascondi utenti disabilitati'":"src='"+skName+"/view.gif' alt='Mostra utenti disabilitati'" %> border='0'><%=viewAll?"Nascondi utenti disabilitati":"Mostra utenti disabilitati"%></a></p>
<p align="center">
