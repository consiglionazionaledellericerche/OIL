...
<title><bean:message key="applicationName" /> - Elimina Nota</title>
<!-- #EndEditable -->
...
<%@ page import ="it.cnr.helpdesk.FaqManagement.dto.*" %>
<!-- #EndEditable --> 
<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
  		<td>
            ...
            <img src="<%=skName%>/titles/CancellaFAQ.gif"><!-- #EndEditable -->
					</td>
...
if(param==null){
	FaqDTO faqDTO =(FaqDTO)request.getAttribute("idf");
%>    

<form name="DeleteFaqForm" method="POST" action="DeleteFaqDetail.do">
        <table border="0" width="100%" cellpadding="2" cellspacing="2">
          <tr> 
            <td width="10%" align="right" valign="top" class="bgheader"><span class="tableheader">Titolo:</span></td>
          <td  width="90%" valign="top" > 
            <input type="text" name="Titolo" value="<%=faqDTO.getTitolo()%>" readonly="YES" size="80">            
          </td>
        </tr>
         <tr> 
            <td width="10%" align="right" valign="top" class="bgheader"><span class="tableheader">Categoria:</span></td>
          <td  width="90%" valign="top" > 
            <input type="text" name="Categoria" value="<%=faqDTO.getDescrizioneCategoria()%>" readonly="YES" size="50">            
          </td>
        </tr>
        <tr> 
            <td width="10%" align="right" valign="top" class="bgheader"><span class="tableheader">Descrizione:</span></td>
          <td  width="90%" valign="top" > 
            <textarea rows="10" name="Descrizione" readonly="YES" cols="80"><%=faqDTO.getDescrizione()%></textarea>
          </td>
        </tr>
      </table>
</form>
...
<p align="center">
<img src="<%=skName%>/buttons/b-delete.gif" alt="delete" onClick="document.DeleteFaqForm.submit()">&nbsp;&nbsp;
<img src='<%=skName%>/buttons/b-annulla.gif' alt='cancel' onclick="window.close();" />
</p>

<%} else if (param.equals("close")){
%>
<p align='center' class='information'>Voce eliminata</p>
<p align='center'>
<img src='<%=skName%>/buttons/b-chiudi.gif' alt='close' onclick="window.opener.location.reload(); window.close();" />
</p>
<%
}
%>	
