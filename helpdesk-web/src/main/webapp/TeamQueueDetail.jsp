...
<title><bean:message key="applicationName" />  - Team: segnalazioni
</title>
<!-- #EndEditable -->
    ...
    <td > 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
            ...
            <a href="TeamProblemCountPerCategory.do" class="navigation">Segnalazioni del Team : <bean:message key="CountPerCategory" /></a> --&gt; <bean:message key="PendingTicketsList" />
            <!-- #EndEditable --></span> 
          </td>
...
<A HREF="#" onClick="window.location='TeamQueueDetail.do?page=0&category=<%=request.getParameter("category")%>&categoryName=<%=request.getParameter("categoryName")%>&print=yes';"><img src='<%=skName%>/buttons/b-print.gif' alt='Versione stampabile' border='0'></a><br>
<p align="center">
