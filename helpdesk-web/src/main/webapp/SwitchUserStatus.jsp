...
<title><bean:message key="applicationName" /> - <bean:message key="pageTitles.SwitchUserStatus" /></title>
<!-- #EndEditable -->
<!-- #BeginEditable "javascripts" -->

<link rel="stylesheet" href="OilStyles.css" type="text/css">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
    				...
    				<td nowrap background="<%=skName%>/NormalHeaderCenter.gif"  align="center" class="sectiontitle"> 
      					<!-- #BeginEditable "SectionTitle" --><img src="<%=skName%>/titles/DisabilitaUtente.gif"><!-- #EndEditable -->
					</td>
...
<%
	...
	if(param.equals("nodis")){
%>
<p class="information">L'utente esperto non può essere disabilitato.</p>
<p align="center"><img src="<%=skName%>/buttons/b-close.gif" onClick="window.close();"></p>
<%
	}
%>
                <br>
            <p align="center" class="text">Sei sicuro di voler <%=(azione.equals("dis")?"dis":"")%>abilitare l'utenza relativa al login &quot;<%=request.getParameter("login")%>&quot; ?
			</p>
			<br>
            <!-- #EndEditable -->
    </td>
  ...
  <tr> 
    ...
    <a href="SwitchUserStatus.do?login=<%=request.getParameter("login")%>&azione=<%=azione%>&confermato=yes"><img src="<%=skName%>/buttons/b-ok.gif" border='0'></a>
