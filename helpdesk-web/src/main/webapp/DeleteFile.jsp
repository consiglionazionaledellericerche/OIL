...
<title><bean:message key="applicationName" /> - Elimina Report</title>
<!-- #EndEditable -->
...
%>
<p class="text">Sei sicuro di voler eliminare il Report ?</p>
<br>
<!-- #EndEditable -->
    </td>
    <td >&nbsp;</td>
  ...
  <tr> 
	...
	<a href="DeleteFile.do?mese=<%=request.getParameter("mese")%>&categoria=<%=request.getParameter("categoria")%>&conf=yes"><img src="<%=skName%>/buttons/b-ok.gif" border="0"></a>
