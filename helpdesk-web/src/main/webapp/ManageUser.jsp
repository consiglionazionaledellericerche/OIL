...
<!-- #BeginEditable "doctitle" --> 
		<title><bean:message key="applicationName" /> - <bean:message key="pageTitles.ManageUsers" /></title>
<!-- #EndEditable -->
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
  		<td>
           ...
           <img src="<%=skName%>/titles/GestisciUtenti.gif"><!-- #EndEditable -->
					</td>
    ...
    <td > 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
            ...
            --&gt; <bean:message key="navigation.ManageUser" /><!-- #EndEditable --></span> 
          </td>
          ...
          <td valign="top" height="400" ><!-- #BeginEditable "Content" --> 
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="text">
              <tr>
				 ...
				 <td width="1"></td> 
		        						<td width="150"  align="center" class="bgheader"><div class="tab"><bean:message key="tabs.ManageUsers" /></div></td>
				<td width="1"></td> 
                    ...
                    <tr> 
                      ...
                      <table width="100%" cellspacing="0" cellpadding="0">
                        ...
                        <% if (uvo.getEnabled().equals("y")) { %> 
                           <td width="33%"><a href="#" onclick="window.open('SwitchUserStatus.do?login=<%=uvo.getLogin()%>&azione=dis','switch','width=800,height=400,menubar=no,resizable=yes,status=no,location=no,toolbar=no,scrollbars=yes')"><img src="<%=skName%>/wstop.gif" alt="Disabilita" border="0"></a></td>
                        <% } else {%>
...
<p><a href='<%=(viewAll?"ManageUser.do?viewAll=n":"ManageUser.do?viewAll=y")+listAll %>'><img <%=viewAll?"src='"+skName+"/hide.gif' alt='Nascondi utenti disabilitati'":"src='"+skName+"/view.gif' alt='Mostra utenti disabilitati'" %> border='0'><%=viewAll?"Nascondi utenti disabilitati":"Mostra utenti disabilitati"%></a></p>
<p align="center">
