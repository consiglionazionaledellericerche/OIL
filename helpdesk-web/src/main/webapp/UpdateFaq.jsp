...
<%@ page import ="java.util.*,it.cnr.helpdesk.CategoryManagement.valueobjects.*,it.cnr.helpdesk.FaqManagement.dto.*,it.cnr.helpdesk.UserManagement.javabeans.User" %>
<!-- #EndEditable --> 
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
  		<td>
            ...
            <img src="<%=skName%>/titles/ModificaCancellaFAQ.gif"><!-- #EndEditable -->
					</td>
...
<table width="100%" border="0" cellpadding="2" cellspacing="0">
	<tr>
	    <td width="150" align="center" class="bgdisable"><a href="GetCreaFaq.do" class="tab">Crea 
	      Faq</a></td>
	    <td width="1"></td> 
	    <td width="180" align="center" class="bgheader"> <div class="tab">Modifica/Cancella
	      Faq</div></td>						                      
	    <td >&nbsp;</td>				
	</tr>
</table>
...
%>    
<table width="100%" cellpadding="2" cellspacing="2" border="3" class="bordertab"> 
  <tr class="bgheader"> 
...
%>
    			...
    			<a href="UpdateFaq.do?category=<%=cvo.getId()%>" class='<%=(actualCategory.equals(""+cvo.getId()))?"selcat":"listcat" %>' ><%= cvo.getNome() %></a>
    		</td>
          </tr>
<%
	}
...
<%
          ...
          <tr class="bgheader"> 
            ...
            <td width="70%" class="tableheader">Modifica</td>
            <td width="70%" class="tableheader">Cancella</td>
          </tr>
<%
...
%>
          <tr>
             ...
             <td align="center">
                <% if (faqDTO.getOriginatore().equals(utente.getLogin())) {%>
                <A  HREF="#" onClick="window.open('GetUpdateFaqDetail.do?idFaq=<%=faqDTO.getIdFaq()%>','FaqDetail','height=600,width=800,scrollbars=yes,toolbar=no,location=no,screenX=100,screenY=20,top=20,left=100','fullscreen=no')"> 
                <img border="0" src="<%=skName%>/edit.gif">
                </A>
                <% } else { %>
                -
                <% } %>
             ...
             <td align="center">
                <% if (faqDTO.getOriginatore().equals(utente.getLogin())) {%>
                <A  HREF="#" onClick="window.open('DeleteFaqDetail.do?idFaq=<%=faqDTO.getIdFaq()%>','FaqDetail','height=600,width=800,scrollbars=yes,toolbar=no,location=no,screenX=100,screenY=20,top=20,left=100','fullscreen=no')"> 
                <img border="0" src="<%=skName%>/deletebutt.gif">
                </A>
                <% } else { %>
                -
                <% } %>
