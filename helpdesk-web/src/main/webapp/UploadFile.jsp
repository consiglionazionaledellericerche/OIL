...
%>
				<table class='text'><tr><td align='center' class='information'><br>
            <%=request.getAttribute("mess")%><br>
            <br></td></tr></table>
				<p align='center'><img src='<%=skName%>/buttons/b-chiudi.gif' alt='Close' onclick="closeMe();">
				</p>
<%
            ...
            <table border="0" width="100%" cellpadding="2" cellspacing="2">
              <tr> 
                <td colspan="2" align="center"> 
                  <form name="AttchmentForm" action="UploadFile.do" method="POST" enctype="multipart/form-data" >
              <span class="information">Aggiorna il repository con il seguente 
              documento locale:</span><br>
                    <br>
					<table cellpadding="5" style="border: thin groove; background-color: #eeeeee;">
                      <tr> 
                        
                  <td height="35" align="right" style="border-style: dotted; border-width: 1px; border-color: #888888; ">file:</td>
                        <td height="35" style="border-style: dotted; border-width: 1px; border-color: #888888;"> 
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<img src="<%=skName%>/buttons/b-annulla.gif" onclick="closeMe();" alt="Annulla" /> 
				  </form> 
				</td>
              </tr>
            </table>
