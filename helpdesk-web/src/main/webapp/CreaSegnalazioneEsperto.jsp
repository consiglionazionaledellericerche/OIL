...
<!--
  ...
  var submitted = false;
  function aggiorna(){
    self.document.forms[0].idCategoria.value=param1;
    self.document.forms[0].descrizioneCategoria.value=param2;
  }

  function aggiornaUtente(){
    self.document.forms[0].nominativoUtente.value=param1;
    self.document.forms[0].idUtente.value=param2;
  }
...
<%@ page import ="java.util.*,it.cnr.helpdesk.ProblemManagement.valueobjects.ProblemValueObject" %>
<!-- #EndEditable --> 
...
%>
		<table width="100%" cellpadding="2" cellspacing="2" class="bordertab">
			...
			<tr> 
				<td width="20%" class="text">Utente</td>
				<td> 
					<input type="text" name="nominativoUtente" value="<%=pvo.getOriginatoreNome()%>" disabled size="100" maxlength="100">
				</td>
			</tr>
			<tr> 
...
<html:form action="/app/CreaSegnalazioneEsperto" >
<html:errors />
                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                      ...
                      <tr>
                        <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Utente</font></td>
                        <td><html:text property="nominativoUtente" readonly="true" size="100" maxlength="50" />
                          <A  HREF="#" onClick="window.open('SearchUser.do','buttonwin','height=430,width=800,scrollbars=yes,toolbar=no,location=no,screenX=100,screenY=20,top=20,left=100','fullscreen=no')"><FONT  SIZE=1 FACE="Verdana, Arial">Seleziona Utente</FONT></A>
                          <html:hidden property="idUtente" /></td>
                      </tr>
                      <tr> 
      ...
      <input type="hidden" name="idCategoria" value="<%=idCategoria%>" >      </td>
    </tr>    
    <tr> 
      <td width="20%"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Oggetto</font></td>
      <td> 
        <html:text property="titolo" size="50" maxlength="50" />      </td>
    </tr>
    <tr> 
