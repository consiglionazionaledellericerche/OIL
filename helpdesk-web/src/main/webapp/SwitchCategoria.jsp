...
<title><bean:message key="applicationName" /> - <bean:message key="pageTitles.SwitchCategoryStatus" /></title>
<!-- #EndEditable -->
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
    				...
    				<td nowrap background="<%=skName%>/NormalHeaderCenter.gif"  align="center" class="sectiontitle"> 
      					...
      					<img src="<%=skName%>/titles/switchCategoria.gif"><!-- #EndEditable -->
					</td>
...
%>
<p class="information">La categoria possiede delle sottocategorie che verranno automaticamente disabilitate.</p>
<%
	}
	if(param.equals("alert")){
%>
<p class="information">La categoria non può essere abilitata se non lo sono tutte le relative categorie 'antenate'.</p>

<p align="center"><img src="<%=skName%>/buttons/b-chiudi.gif" onClick="window.close();"></p>

<%
	} else {
%>
<p class="text">Sei sicuro di voler <%=(azione.equals("dis")?"dis":"")%>abilitare la categoria &quot;<%=request.getParameter("nome")%>&quot; ?</p>
<br>
<!-- #EndEditable -->
    </td>
    <td >&nbsp;</td>
  ...
  <tr> 
	...
	<a href="SwitchCategoria.do?id=<%=request.getParameter("id")%>&azione=<%=azione%>&confermato=yes"><img src="<%=skName%>/buttons/b-ok.gif" border="0"></a>
