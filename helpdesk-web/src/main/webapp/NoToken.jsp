...
<title><bean:message key="applicationName" bundle="<%=proj%>" /> - <bean:message key="userErrors.NoToken" />
</title>
<!-- InstanceEndEditable -->
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td background="<%=skName%>/NormalHeaderCenter.gif"  align="center" class="sectiontitle"><!-- InstanceBeginEditable name="Title" -->
...
<p class="information">
	<bean:message key="userErrors.NoToken" />
</p>
<p class="highlightedText"><a  href="Logout.do"><bean:message key="navigation.logout" bundle="<%=proj%>" /></a></p>
<!-- InstanceEndEditable --></td>
    <td >&nbsp;</td>
  </tr>
  <tr>
