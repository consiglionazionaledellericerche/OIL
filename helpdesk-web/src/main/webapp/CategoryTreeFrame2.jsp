    ...
    <td> 
      ...
      <table border="0" width="100%" align="center">
        <tr> 
          ...
          <td width="60%" align="center"valign="top"><!-- #BeginEditable "Buttons" -->
          <img src='<%=skName%>/buttons/b-ok.gif' alt='Ok' onclick="window.parent.mainFrame.document.forms[0].submit();">
	<!-- #EndEditable --></td>
