...
<title>Online interactive helpdesk - Dettaglio Nota</title>
<!-- #EndEditable -->
...
<%@ page import ="it.cnr.helpdesk.ProblemManagement.valueobjects.*" %>
<!-- #EndEditable --> 
...
EventValueObject evo=(EventValueObject) request.getAttribute("evo");
if(evo!=null){
%>    
      ...
      <table border="0" width="100%" cellpadding="2" cellspacing="2">
        <tr> 
          <td width="10%" align="right" valign="top" class="bgheader"><span class="tableheader">Nota:</span></td>
          <td  width="90%" valign="top" > 
            <textarea rows="10" name="Nota" cols="80"><%=evo.getNote()%></textarea>
          </td>
        </tr>
      </table>
