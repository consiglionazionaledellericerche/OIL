        ...
        <tr> 
          <td valign="top" height="400" ><!-- #BeginEditable "Content" --> 
            <table width="100%" border="0" cellpadding="2" cellspacing="0">
              <tr> 
                <td width="180"  align="center" class="<%=(cl==78)?"bgheader":"bgdisable"%>" ><%=(cl==78)?"<div class='tab'>":"<a href='ProblemCountPerCategoryValidator.do?closed=NO' class='tab'>"%><bean:message key="PendingTickets" /><%=(cl==78)?"</div>":"</a>"%></td>
                <td width="1"></td>
                <td width="150" align="center" class="<%=(cl==89)?"bgheader":"bgdisable"%>"><%=(cl==89)?"<div class='tab'>":"<a href='ProblemCountPerCategoryValidator.do?closed=YES' class='tab'>"%><bean:message key="ClosedTickets" /><%=(cl==89)?"</div>":"</a>"%></td>
                <td >&nbsp;</td>
              </tr>
            </table>	 
...
%>
                    <tr> 
                      <td align="right"><a href="ValidatorQueueDetail.do?category=<%= pcvo.getIdCategoria()%>&categoryName=<%= pcvo.getNomeCategoria()%>"><%= pcvo.getNomeCategoria()%></a></td>
                      <td>&nbsp;</td>
