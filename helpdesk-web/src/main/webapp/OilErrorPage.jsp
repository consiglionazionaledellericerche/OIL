 ...
 *     along with this program.  If not, see <https://www.gnu.org/licenses/>.
 --%>
<html><!-- InstanceBegin template="/Templates/OilErrorPage.dwt" codeOutsideHTMLIsLocked="true" -->
...
<!-- #EndEditable --> 
<!-- #BeginEditable "ErrorPage" --><%@ page isErrorPage="true" %><!-- #EndEditable -->
...
<title>Online interactive helpdesk - Error Page</title>
<!-- #EndEditable -->
...
<%@ page import ="java.util.*,it.cnr.helpdesk.exceptions.*,java.io.*" %>
<!-- #EndEditable -->
...
<table width="100%" border="3" bordercolor="red">
	<tr>
		<td>	
           <span class="errorPageText">Errore di sistema:<br><br>
...
%>
           In caso di necessità contattare l'assistenza al seguente indirizzo: <a href="#" onClick="window.open('Contatti.do','Contatti','height=350,width=400,scrollbars=yes,toolbar=no,location=no,status=no,resizable=yes,menubar=no,screenX=100,screenY=20,top=20,left=100')"><bean:message key="texts.email" bundle="<%=proj%>" /></a></span> 
          </td>
	</tr>
</table>
	<!-- #EndEditable -->
  ...
  <tr> 
    <td align="center"><!-- #BeginEditable "Buttons" --> 
      <input type="button" name="Back" value="Torna indietro"  onClick="history.back();">
      <!-- #EndEditable --></td>
    <td >&nbsp;</td>
  </tr>
  <tr> 
