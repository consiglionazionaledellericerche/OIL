...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
          ...
          <td background="<%=skName%>/NormalHeaderCenter.gif"  align="center" class="sectiontitle"> 
            ...
            Pagina di Errore<!-- #EndEditable --> </td>
...
<table width="100%" border="3" bordercolor="green">
	<tr>
		<td>	
           <span class="errorPageText">Errore durante il cambio di stato:<br><br>
           <font color="green"><html:errors /></font><br><br>
