...
<title>Online interactive helpdesk Modifica Messaggio</title>
<!-- #EndEditable -->
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
  		<td>
            ...
            Modifica Messaggio<!-- #EndEditable -->
					</td>
...
<table align='center' class="bordertab">
	...
	<tr><td><textarea disabled rows="10" cols="60"><%= request.getParameter("Mess") %></textarea></td></tr>
...
%>
<form name="ModificaMessaggio" method="POST" action="UpdateMessage.do">
        <table border="0" width="100%" cellpadding="2" cellspacing="2">
          <tr class="bgheader"> 
            ...
            <td width="90%"> 
              ...
              <textarea rows="10" name="Mess" cols="60"><%= request.getAttribute("testo") %></textarea>
    </td>
  </tr>
</table>
