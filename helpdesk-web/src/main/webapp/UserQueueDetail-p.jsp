...
<table border="0" width="100%" cellpadding="2" cellspacing="2">
	...
	<tr> 
		  <td width="10%" class="ptableheader">Id</td>
		  <td width="40%" class="ptableheader">Oggetto</td>
		  <td width="10%" class="ptableheader">Stato</td>
		  <td width="10%" class="ptableheader">Categoria</td>
		  <td width="20%" class="ptableheader">Esperto</td>
		  <td width="10%" class="ptableheader">Data</td>
    </tr>
<%
while (i.hasNext()) {
...
%>
    <tr> 
		<td class="ptablebody"><%=plivo.getIdSegnalazione()%></td>
		<td class="ptablebody"><%=plivo.getTitolo()%></td>
		<td class="ptablebody"><%=plivo.getStato()%></td>
		<td class="ptablebody"><%=plivo.getCategoriaDescrizione()%></td>
		<td class="ptablebody"><%=plivo.getEsperto()%></td>
		<td class="ptablebody"><%=plivo.getData()%></td>
    </tr>
<%
}
%>
