...
public class HorizontalBarChartConf
    implements ChartConf
{

    public HorizontalBarChartConf(String s, Paint apaint[], Paint paint, String s1, String s2, CategoryDataset categorydataset, boolean flag, 
    ...
    public HorizontalBarChartConf(String s, Paint apaint[], Paint paint, String s1, String s2, CategoryDataset categorydataset, boolean flag, 
            boolean flag1, boolean flag2, int i, int j)
    {
        title = s;
        paints = apaint;
        bgPaint = paint;
            ...
            boolean flag1, boolean flag2, int i)
    {
        ...
        urls = flag2;
        width = i;
        height = categorydataset.getCategoryCount() * 30 + 180;
    }
