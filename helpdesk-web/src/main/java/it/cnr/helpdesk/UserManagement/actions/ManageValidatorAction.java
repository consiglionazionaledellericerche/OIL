 ...
 */
public class ManageValidatorAction extends Action {

	private static Log log = LogFactory.getLog(ManageValidatorAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws UserJBException, SettingsJBException {
		log.warn("In execute method of ManageValidatorAction");

		HttpSession session = request.getSession();
		String instance = (String)session.getAttribute("it.cnr.helpdesk.instance");
		User utente = new User();
		String thisAction = new String("ManageValidator.do");
		...
		if (p != null) {
			...
			return mapping.findForward("ManageValidator");
