 ...
 */
public class GetCreaSegnalazioneEspertoAction extends Action {
    private static Log log = LogFactory.getLog(GetCreaSegnalazioneEspertoAction.class);
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws SettingsJBException {
        log.warn("In execute method of GetCreaSegnalazioneEspertoAction");
