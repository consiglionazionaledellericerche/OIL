 ...
 */
public class DeleteFaqDetailAction extends Action {
    private static Log log = LogFactory.getLog(DeleteFaqDetailAction.class);
    
    public ActionForward execute(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response)
    throws FaqJBException {
        log.warn("In execute method of DeleteFaqDetailAction");
        ...
        return mapping.findForward("DeleteFaqDetail");
    }
